...
#    device = 'cpu'
    ...
    train_loader = torch.utils.data.DataLoader(trainset, batch_size=64,#batch_size,
    ...
    # Save model
    torch.save(model.state_dict(), "/home/yoon/Yoon/pytorch/research/only_gpu/test.pth")
