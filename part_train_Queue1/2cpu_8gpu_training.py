...
class Net(nn.Module):
    def __init__(self):
        ...
        self.trash1 = torch.zeros((16, 8, 24, 24,))
        self.trash2 = torch.zeros((16, 24, 8, 8, ))
...
class Net2(nn.Module):
    def __init__(self):
        ...
        self.fc2 = nn.Linear(1000, 10)
        self.fc3 = nn.Linear(100,10)
        self.trash1 = torch.zeros((16, 2, 24, 24,)).to("cuda")
        self.trash2 = torch.zeros((16, 6, 8, 8, )).to("cuda")
...
def main():
    ...
    # Save model
    torch.save(model1.state_dict(), "/home/yoon/Yoon/pytorch/research/part_train/cpu.pth")
    
    # Save model
    torch.save(model2.state_dict(), "/home/yoon/Yoon/pytorch/research/part_train/gpu.pth")
