...
class Net(nn.Module):
    def __init__(self):
        ...
        self.trash1 = torch.zeros((16, 80, 24, 24,))
        self.trash2 = torch.zeros((16, 240, 8, 8, ))
...
class Net2(nn.Module):
    def __init__(self):
        ...
        self.fc2 = nn.Linear(1000, 10)
        self.fc3 = nn.Linear(100,10)
        self.trash1 = torch.zeros((16, 20, 24, 24,)).to("cuda")
        self.trash2 = torch.zeros((16, 60, 8, 8, )).to("cuda")
...
def main():
    ...
    # Save model
    torch.save(model1.state_dict(), "/home/yoon/Yoon/pytorch/research/pth/cpu_20:80.pth")
    
    # Save model
    torch.save(model2.state_dict(), "/home/yoon/Yoon/pytorch/research/pth/gpu_20:80.pth")
